...
const products: Record<string, Product> = {
  ...
  pro: {
    ...
    kitItems: ["Diamond Sword (Sharpness III)", "Diamond Pickaxe", "Diamond Axe", "Diamond Helmet (Protection III)", "Diamond Chestplate (Protection III)", "Diamond Leggings (Protection III)", "Diamond Boots (Protection III)", "32x Golden Apples"],
  ...
  elite: {
    ...
    kitItems: ["Diamond Sword (Sharpness IV)", "Diamond Pickaxe", "Diamond Axe", "Diamond Shovel", "Diamond Hoe", "Diamond Helmet (Protection V, Unbreaking V, Mending)", "Diamond Chestplate (Protection V, Unbreaking V, Mending)", "Diamond Leggings", "Diamond Boots", "Milk Bucket", "Iron Block", "Bed", "64x Golden Apples"],
  ...
  legend: {
    ...
    kitItems: ["Diamond Sword (Sharpness V)", "Diamond Pickaxe", "Diamond Axe", "Diamond Helmet (Protection VI, Thorns III, Unbreaking VI, Mending)", "Diamond Chestplate (Protection VI, Thorns III, Unbreaking VI, Mending)", "Diamond Leggings", "Diamond Boots", "Golden Apple x32", "Golden Block x2", "Ladder"],
  ...
  immortal: {
    ...
    kitItems: ["Diamond Sword (Sharpness VI)", "Diamond Pickaxe", "Diamond Axe", "Diamond Helmet (Protection VII, Unbreaking VII, Mending)", "Diamond Chestplate (Protection VII, Unbreaking VII, Mending)", "Diamond Leggings", "Diamond Boots", "Slime Block x2", "Ladder", "Fishing Rod"],
  ...
  deadliest: {
    ...
    kitItems: ["Diamond Sword (Sharpness VII)", "Diamond Pickaxe", "Diamond Axe", "Diamond Helmet (Bolt Armor Trim, Protection VIII, Fire Protection VIII, Respiration VIII, Unbreaking VIII, Mending VIII)", "Diamond Chestplate (Bolt Armor Trim, Redstone Material, Protection VIII, Fire Protection VIII, Respiration VIII, Unbreaking VIII, Mending VIII)", "Diamond Leggings", "Diamond Boots", "Shulker Box", "Potion x4", "Fishing Rod"],
    qrLink: "https://spicysmp.dpdns.org/deadliest.html",
  },
  supreme: {
    type: "rank",
    name: "SUPREME RANK",
    description: "The ultimate status. Dominate with maximum slots and all commands.",
    kitName: "SUPREME Kit",
    image: supremeRank,
    tier: "supreme",
    durations: [
    ...
    kitItems: ["Netherite Sword (All Max Enchants)", "Netherite Pickaxe", "Netherite Axe", "Netherite Helmet (All Max Enchants)", "Netherite Chestplate (All Max Enchants)", "Netherite Leggings (All Max Enchants)", "Netherite Boots (All Max Enchants)", "Notch Apple x32", "Totem x8", "Mace (Exclusive)"],
    qrLink: "https://spicysmp.dpdns.org/supreme.html",
  },
  spicy: {
    type: "rank",
    name: "SPICY RANK",
    description: "The ultimate signature rank! Get all fiery perks and dominate SPICYSMP with exclusive fire-themed legendary items.",
    kitName: "SPICY Kit",
    image: spicyRank,
    tier: "spicy",
    durations: [
    ...
    kitItems: ["Netherite Sword (Fire Aspect III, All Max)", "Netherite Pickaxe", "Netherite Axe", "Netherite Helmet (Fire Protection V, All Max)", "Netherite Chestplate (Fire Protection V, All Max)", "Netherite Leggings (Fire Protection V, All Max)", "Netherite Boots (Fire Protection V, All Max)", "Notch Apple x64", "Totem x16", "Blaze Spawner"],
  ...
  "purple-key": {
    type: "key",
    name: "Purple Key",
    description: "The ultimate key with maximum enchantments and the exclusive Mace weapon.",
    price: 30,
    isFree: false,
