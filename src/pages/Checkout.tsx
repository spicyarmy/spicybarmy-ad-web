...
const products: Record<string, Product> = {
  ...
  spicy: {
    ...
    perks: ["All Fire Perks", "Unlimited Homes", "/god Command", "Flame Particles", "Custom Fire Trail", "Spicy Crown Tag", "VIP Priority"],
    kitItems: ["Netherite Helmet (Fire Protection V, All Max)", "Netherite Chestplate (Fire Protection V, All Max)", "Netherite Leggings (Fire Protection V, All Max)", "Netherite Boots (Fire Protection V, All Max)", "Netherite Sword (Fire Aspect III, All Max)", "Notch Apple x64", "Totem x16", "Blaze Spawner"],
